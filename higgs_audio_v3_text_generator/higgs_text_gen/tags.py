...
SFX_TAGS = {
    "laughter": {
        "cn": "笑声",
        "onomatopoeia_cn": ["哈哈", "嘿嘿", "呵呵", "嘻嘻"],
        "onomatopoeia_en": ["Haha", "Hehe", "Hoho"],
    },
    "sigh": {
        "cn": "叹气",
        "onomatopoeia_cn": ["唉", "哎", "呼", "嗯"],
        "onomatopoeia_en": ["Ahh", "Ugh", "Sigh", "Oh"],
    },
    "cough": {"cn": "咳嗽", "onomatopoeia_cn": ["咳咳", "咳"], "onomatopoeia_en": ["Ahem", "Cough"]},
    "crying": {"cn": "哭泣", "onomatopoeia_cn": ["呜呜", "呜", "嘤嘤"], "onomatopoeia_en": ["Sob", "Boo hoo"]},
    "screaming": {"cn": "尖叫", "onomatopoeia_cn": ["啊", "呀"], "onomatopoeia_en": ["Ahh", "Noo", "Aaa"]},
    "humming": {"cn": "哼唱/沉吟", "onomatopoeia_cn": ["嗯", "哼"], "onomatopoeia_en": ["Hmm", "Mmm"]},
    "sniff": {"cn": "抽鼻子", "onomatopoeia_cn": ["吸", "嘶"], "onomatopoeia_en": ["Sniff", "Snf"]},
    "sneeze": {"cn": "打喷嚏", "onomatopoeia_cn": ["阿嚏", "哈啾"], "onomatopoeia_en": ["Achoo", "Atchoo"]},
    "burping": {"cn": "打嗝", "onomatopoeia_cn": ["嗝", "呃"], "onomatopoeia_en": ["Burp", "Ugh"]},
}
